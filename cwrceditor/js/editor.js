...
//			elements: 'editor',
			...
			theme_advanced_buttons1: 'schematags,|,addperson,addplace,adddate,addevent,addorg,addcitation,addnote,addtitle,addcorrection,addkeyword,addlink,|,editTag,removeTag,|,addtriple,|,viewsource,editsource,|,validate,savebutton,saveasbutton,loadbutton,|,addWorkflowStamp',
			...
			setup: function(ed) {
				...
				ed.addButton('addWorkflowStamp', {title: 'Add Workflow Stanp', image: 'img/report_add.png', 'class': 'entityButton',
					onclick: function() {
						// alert("adding stamp " + w.docPID);
						// XXX Move this code to a more suitable place

						// save document
						// alert(w.fm.exportDocument(true));
						
						writer.cwrcDialogs.addWorkflowStamp(w.docPID, w.fm.exportDocument(true), function(){});
